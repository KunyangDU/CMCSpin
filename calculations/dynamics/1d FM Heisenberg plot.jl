...
save("dynamics/figures/dynamics_$(Lx)x$(Ly)_$(Nt)_$(τ)_$(params)_examples.pdf",fig)
save("dynamics/figures/dynamics_$(Lx)x$(Ly)_$(Nt)_$(τ)_$(params)_examples.png",fig)
