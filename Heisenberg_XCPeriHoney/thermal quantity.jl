...
Label(fig[0,1],text = "$(Lx)x$(Ly) PBC Tria, $(params)")

resize_to_layout!(fig)
display(fig)

save("Heisenberg_XCPeriHoney/figures/thermal quantity_$(Lx)x$(Ly)_$(params)_$(T0)_$(T)_$(α)_$(Nt)_$(N).pdf",fig)
save("Heisenberg_XCPeriHoney/figures/thermal quantity_$(Lx)x$(Ly)_$(params)_$(T0)_$(T)_$(α)_$(Nt)_$(N).png",fig)
